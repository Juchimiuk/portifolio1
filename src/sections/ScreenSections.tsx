...
const ScreenSection: React.FC = () => (
  <section
    ...
    "
  >
    {/* Wrapper vermelho full-width sem container */}
    <div className="flex flex-col lg:flex-row items-center justify-between w-full gap-12">
      {/* Texto à esquerda */}
      <div className="w-full lg:w-1/2 flex flex-col items-start justify-center text-left z-10 px-4 lg:px-16 py-20">
        ...
        <ul className="mb-8 space-y-3 max-w-xl">
          <li className="flex items-start gap-2">
            ...
            <span className="text-white/90 text-base leading-relaxed">
              Controle completo de voos e utilização por sócios ou usuários.
            </span>
          </li>
          <li className="flex items-start gap-2">
            <span className="inline-block w-2 h-2 mt-2 rounded-full bg-sky-300" />
            <span className="text-white/90 text-base leading-relaxed">
              Relatórios detalhados e personalizados para transparência e gestão.
            </span>
          </li>
          <li className="flex items-start gap-2">
            <span className="inline-block w-2 h-2 mt-2 rounded-full bg-sky-300" />
            <span className="text-white/90 text-base leading-relaxed">
              Ideal para aeronaves compartilhadas ou de controle individualizado.
            </span>
          </li>
        </ul>
      ...
      {/* Imagem à direita sem margens */}
      <div className="w-full lg:w-1/2 relative z-10 h-auto">
        <img
          src="laptop.png"
