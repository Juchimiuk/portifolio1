...
const ContactInfoSection: React.FC = () => (
  <section id="contact-info" className="py-14">
    <div className="container mx-auto px-4 text-center">
      <h3 className="text-3xl sm:text-4xl font-extrabold text-sky-900  mt-2 mb-12 tracking-tight">Fale Conosco</h3>
      <div className=" mb-14 grid grid-cols-2 md:grid-cols-4 gap-8">
        <div className="flex flex-col items-center bg-white rounded-2xl shadow-md p-8">
          <FaPhoneAlt className="text-sky-900 w-8 h-8 mb-4" />
          <h3 className="text-lg font-bold mb-2 text-sky-900">Telefone</h3>
          <p className="text-gray-600 text-base">(047) 3046-8216</p>
        </div>
        <div className="flex flex-col items-center bg-white rounded-2xl shadow-md p-8">
          <FaEnvelope className="text-sky-900 w-8 h-8 mb-4" />
        ...
        <div className="flex flex-col items-center bg-white rounded-2xl shadow-md p-8">
          <FaMapMarkerAlt className="text-sky-900 w-8 h-8 mb-4" />
        ...
        <div className="flex flex-col items-center bg-white rounded-2xl shadow-md p-8">
          <FaInfo className="text-sky-900 w-8 h-8 mb-4" />
